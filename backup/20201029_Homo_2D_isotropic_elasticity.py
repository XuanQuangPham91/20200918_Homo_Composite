...
circle = Circle(Point(0.5, 0.5), R, segments=16)
domain = rectangle
...
plt.xlabel('$y_1$')
plt.ylabel('$y_2$')
plt.savefig('results/grad_e0.eps', format='eps')
...
plt.xlabel('$y_1$')
plt.ylabel('$y_2$')
plt.savefig('results/grad_e1.eps', format='eps')
...
plt.xlabel('$y_1$')
plt.ylabel('$y_2$')
plt.savefig('results/grad_e2.eps', format='eps')
